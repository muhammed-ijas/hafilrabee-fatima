...
const STORAGE_KEY = "nikah_blessings_v2";
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <div className="text-center mb-14 reveal">
          <p
            ...
            style={{ color: "#7dd87a", fontSize: "2.2rem", marginBottom: "12px", lineHeight: 1.5 }}
          >
            بارك الله لكما
          </p>
          <p
            className="font-display"
            style={{ color: "#4a7a4a", fontSize: "9px", letterSpacing: "0.4em", textTransform: "uppercase", marginBottom: "10px" }}
          >
            ✦ Blessings &amp; Greetings ✦
          </p>
          <h2
            className="font-body"
            style={{ fontSize: "clamp(1.6rem, 5vw, 2.2rem)", fontWeight: 300, color: "#e8f4d0", marginBottom: "8px" }}
          >
            Leave a Prayer or Message
          </h2>
          <p
            className="font-body"
            style={{ color: "#2d5a2d", fontSize: "14px", fontStyle: "italic" }}
          >
        ...
        >
          ...
          <div className="mb-5">
            <label
              ...
              style={{ color: "#5a9a5a", fontSize: "9px", letterSpacing: "0.28em", textTransform: "uppercase" }}
            >
              Your Name
            </label>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows={4}
                className="w-full rounded-xl pl-10 pr-4 py-3 text-sm resize-none"
                style={{
                  background: "rgba(255,255,255,0.04)",
          ...
          {error && (
            <p className="font-body mb-3" style={{ color: "#e07070", fontSize: "13px" }}>
              {error}
            </p>
          )}
          ...
          {submitted && (
            ...
            >
              ...
              <p className="font-body" style={{ color: "#90d070", fontSize: "14px" }}>
          ...
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #2a5a3a, #1a3d2b)",
              color: "#c8df60",
        ...
        {blessings.length === 0 ? (
          <div className="text-center py-10 reveal">
            <svg className="mx-auto mb-3 opacity-15" width="36" height="36" viewBox="0 0 36 36" fill="none">
              <path
                d="M18 33C18 33 4 24 4 13C4 8.03 8.03 4 13 4C15.83 4 18.37 5.27 20 7.36C21.63 5.27 24.17 4 27 4C31.97 4 36 8.03 36 13C36 24 22 33 18 33Z"
                stroke="#a0c87a"
                strokeWidth="1.2"
              />
            </svg>
            <p className="font-body" style={{ color: "#2d4020", fontSize: "13px", fontStyle: "italic" }}>
          ...
          <div className="reveal">
            <p
              ...
              style={{ color: "#3d6030", fontSize: "9px", letterSpacing: "0.28em", textTransform: "uppercase" }}
            >
              ...
              {blessings.map((b, i) => (
                <div
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(160,200,122,0.1)",
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      {/* Avatar */}
                      <div
                        className="w-10 h-10 rounded-full flex items-center justify-center font-body flex-shrink-0"
                        style={{
                          background: "rgba(160,200,122,0.1)",
                          border: "1px solid rgba(160,200,122,0.2)",
                          color: "#a0c87a",
                          fontSize: "16px",
                          fontWeight: 500,
                        }}
                      ...
                      <div>
                        <p className="font-body" style={{ color: "#e8f4d0", fontSize: "15px", fontWeight: 500 }}>
                          {b.name}
                        </p>
                        <p className="font-display" style={{ color: "#2d4020", fontSize: "9px", letterSpacing: "0.1em" }}>
                          {b.time}
                        </p>
                      </div>
                    </div>
        ...
        {/* Footer dua */}
        <div
          className="text-center mt-20 pt-10 reveal"
          style={{ borderTop: "1px solid rgba(160,200,122,0.12)" }}
        >
          ...
          <p
            className="font-arabic"
            style={{ color: "#7dd87a", fontSize: "clamp(1.1rem, 3vw, 1.6rem)", marginBottom: "12px", lineHeight: 1.7 }}
          >
            بارك الله لكما وبارك عليكما وجمع بينكما في خير
          </p>
          <p
            className="font-body"
            style={{ color: "#5a9a5a", fontSize: "13px", fontStyle: "italic", letterSpacing: "0.05em", marginBottom: "20px" }}
          >
          ...
          <p
            className="font-display"
            style={{ color: "#2a4a2a", fontSize: "9px", letterSpacing: "0.2em" }}
          >
