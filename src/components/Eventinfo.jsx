...
const MosqueMinaret = () => (
  <svg viewBox="0 0 200 280" fill="none" className="w-full h-full opacity-[0.06]">
    ...
    {[60, 80, 100, 140].map((y, i) => (
      <g key={i}>
        <rect x="92" y={y} width="16" height="14" rx="8" fill="#0d2419" opacity={0.4} />
      </g>
    ))}
  </svg>
);
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16 reveal">
          <p
            ...
            style={{ color: "#a0c87a", fontSize: "2rem", marginBottom: "8px" }}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <svg className="absolute inset-0 w-full h-full opacity-[0.04]" viewBox="0 0 200 200" fill="none">
              <polygon points="60,5 140,5 195,60 195,140 140,195 60,195 5,140 5,60"
                stroke="#b8963c" strokeWidth="1" fill="none" />
            </svg>
            ...
            <p
              className="font-display"
              style={{ color: "#6a9a5a", fontSize: "9px", letterSpacing: "0.36em", textTransform: "uppercase", marginBottom: "16px" }}
            >
              When
            </p>

            <p className="font-body" style={{ color: "#c8df60", fontSize: "1.1rem", fontWeight: 500, letterSpacing: "0.06em" }}>Sunday</p>
            <p
              className="font-display"
              style={{ color: "#ffffff", fontSize: "3rem", fontWeight: 400, lineHeight: 1, letterSpacing: "0.04em", margin: "4px 0" }}
            >
              APR 26
            </p>
            <p className="font-body" style={{ color: "#a0c87a", fontSize: "1.2rem", marginBottom: "20px" }}>2026</p>

            <div className="h-px mb-5" style={{ background: "rgba(255,255,255,0.08)" }} />

            <p className="font-display" style={{ color: "#ffffff", fontSize: "12px", letterSpacing: "0.14em" }}>
              TIME: 11:00 AM
            </p>
            <p className="font-body" style={{ color: "#4a7a4a", fontSize: "12px", fontStyle: "italic", marginTop: "4px" }}>
          ...
          <div
            ...
            style={{
              ...
              border: "1.5px solid rgba(184,150,60,0.3)",
            }}
          >
            <div className="mb-3">
              <svg width="28" height="28" viewBox="0 0 36 36" fill="none">
                <path
                  d="M18 3C12.48 3 8 7.48 8 13c0 8.25 10 20 10 20s10-11.75 10-20c0-5.52-4.48-10-10-10z"
                  stroke="#b8963c"
                  strokeWidth="1.2"
                />
            ...
            <p
              className="font-display"
              style={{ color: "#b8963c", fontSize: "9px", letterSpacing: "0.36em", textTransform: "uppercase", marginBottom: "14px" }}
            >
              Where
            </p>
            ...
            <h3
              className="font-body"
              style={{ fontSize: "1.15rem", fontWeight: 500, color: "#1a3d2b", marginBottom: "4px", lineHeight: 1.3 }}
            >
            ...
            <p
              className="font-body"
              style={{ color: "#5a7a5a", fontSize: "13px", lineHeight: 1.7, marginBottom: "14px" }}
            >
          ...
          <div
            ...
            style={{
              background: "rgba(255,255,255,0.04)",
              border: "1px solid rgba(160,200,122,0.18)",
            }}
          >
            <svg className="absolute inset-0 w-full h-full opacity-[0.04]" viewBox="0 0 200 200" fill="none">
              <polygon points="60,5 140,5 195,60 195,140 140,195 60,195 5,140 5,60"
                stroke="#a0c87a" strokeWidth="1" fill="none" />
            </svg>

            <div className="mb-5">
              <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
                <path
                  d="M18 32C18 32 4 23 4 13C4 8.03 8.03 4 13 4C15.83 4 18.37 5.27 20 7.36C21.63 5.27 24.17 4 27 4C31.97 4 36 8.03 36 13C36 23 22 32 18 32Z"
                  stroke="#a0c87a"
                  strokeWidth="1.2"
                  strokeLinecap="round"
            ...
            <p
              className="font-arabic"
              style={{ color: "#a0c87a", fontSize: "1.4rem", lineHeight: 1.8, marginBottom: "12px" }}
            >
              بارك الله لكما
            </p>
            ...
            <p
              className="font-body"
              style={{ color: "#c0e0a0", fontSize: "15px", fontStyle: "italic", lineHeight: 1.8, marginBottom: "16px" }}
            >
              &ldquo;With love, prayers,<br />and heartfelt duas&rdquo;
            </p>

            <p
              className="font-body"
              style={{ color: "#4a7a4a", fontSize: "12px", lineHeight: 1.7 }}
            >
        ...
        <div className="text-center mt-14 reveal delay-400">
          ...
          <p className="font-display" style={{ color: "#4a7a4a", fontSize: "9px", letterSpacing: "0.3em", textTransform: "uppercase", marginBottom: "8px" }}>
            Hosted By
          </p>
          <p className="font-body" style={{ color: "#e8f4d0", fontSize: "1.2rem" }}>
          ...
          <a
            ...
            style={{ color: "#b8963c", fontSize: "13px", fontFamily: "'Numans', sans-serif", textDecoration: "none" }}
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
              <path
                d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.11-.21c1.21.49 2.53.76 3.88.76a1 1 0 011 1V20a1 1 0 01-1 1C10.02 21 3 13.98 3 5a1 1 0 011-1h3.5a1 1 0 011 1c0 1.36.27 2.67.76 3.88a1 1 0 01-.64 1.91z"
                stroke="#b8963c"
                strokeWidth="1.3"
                strokeLinecap="round"
              />
