...
const EventInfo = () => {
  ...
  window.open("https://maps.google.com/?q=11.003587003778602,76.42857961385722", "_blank");
};
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute right-0 top-0 bottom-0 w-32 pointer-events-none hidden md:block"
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, transparent, rgba(184,150,60,0.4), transparent)",
        }}
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16 reveal">
          ...
          <div className="flex items-center justify-center gap-3 mt-4">
            <div
              className="h-px w-14"
              style={{ background: "#b8963c", opacity: 0.4 }}
            />
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path
                d="M9 0L10.5 6.5L17 8L10.5 9.5L9 16L7.5 9.5L1 8L7.5 6.5Z"
                fill="#b8963c"
                opacity={0.7}
              />
            </svg>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            >
              <polygon
                points="60,5 140,5 195,60 195,140 140,195 60,195 5,140 5,60"
                stroke="#b8963c"
                strokeWidth="1"
                fill="none"
              />
          ...
          >
            ...
            >
             <iframe
  src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d489.55830647610696!2d76.42857961385722!3d11.003587003778602!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTHCsDAwJzEyLjgiTiA3NsKwMjUnNDMuMSJF!5e0!3m2!1sen!2sin!4v1775462566438!5m2!1sen!2sin"
  width="100%"
  height="180"
...
/>
          ...
          >
            ...
            >
              We warmly invite our beloved relatives, family, and friends to
              shower the couple with your blessings.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-14 reveal delay-400">
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, transparent, rgba(184,150,60,0.25), transparent)",
            }}
          />
          <p
            style={{
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, transparent, rgba(184,150,60,0.3), transparent)",
        }}
      />
